...
private:
  ...
  VkPipelineLayout pipleineLayout;
  ...
  void createInstance()
  {
    ...
    vkEnumerateInstanceExtensionProperties(
      nullptr, &extensionCount, extensionsList.data());
  ...
  bool checkExtensions(const char** glfwEx,
                       uint32_t glfwExCount,
  ...
  void createSwapChain()
  {
    ...
    stQueueFamilyIndices indices = findQueueFamilies(physicalDevice);
  ...
  {
    stQueueFamilyIndices indices = findQueueFamilies(device);
  ...
  // More complex way of getting suitable GPU
  int rateDeviceSuitability(VkPhysicalDevice device)
  {
    ...
    // TODO: On mac gpu somehow don't have geometry shader feature
    // Looks like there is no support of geometry shader in MoltenVk and in
    // Metal because it's not used so often, I assume
  ...
  {
    stQueueFamilyIndices queueFamilyIndices = findQueueFamilies(physicalDevice);
